...
const YesNoPopup: React.FC<YesNoPopupProps> = ({
  title,
  message,
  icon,
  visible,
        ...
        >
          ...
          <div className="flex flex-col md:flex-row-reverse mt-5 gap-2 md:gap-0">
            ...
            <button
              ...
              onClick={onCancel}
              className="w-full justify-center rounded-xl px-4 py-2 bg-background-4 font-medium sm:ml-3 sm:w-auto sm:text-sm"
            >
              Cancel
            </button>
          </div>
